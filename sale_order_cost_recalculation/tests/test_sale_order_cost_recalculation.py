...
class TestSaleOrderCostRecalculation(TransactionCase):
    ...
    def test_02_purchase_date(self):
        price_history_obj = self.env["stock.valuation.layer"]
        ...
        for vals in [
            {
                ...
                "stock_move_id": [
                    (
                        ...
                        0,
                        {
                            "date": now_dt + relativedelta(days=-10),
                            "product_id": self.product1.id,
                        },
                    )
                ],
            },
            {
                ...
                "stock_move_id": [
                    (
                        ...
                        0,
                        {
                            "date": now_dt + relativedelta(days=-20),
                            "product_id": self.product1.id,
                        },
                    )
                ],
            },
            {
                ...
                "stock_move_id": [
                    (
                        ...
                        0,
                        {
                            "date": now_dt + relativedelta(days=-30),
                            "product_id": self.product1.id,
                        },
                    )
                ],
            },
            {
                ...
                "stock_move_id": [
                    (
                        ...
                        0,
                        {
                            "date": now_dt + relativedelta(days=-40),
                            "product_id": self.product1.id,
                        },
                    )
                ],
