...
class MrpProduction(models.Model):
    ...
    #  tempi di lavorazione o ai costi dei centri di lavoro. Infine vanno aggiornati
    ...
    def _cal_price(self, consumed_moves):
        ...
        TODO Overwritten to set cost of finished products to the current cost.
        The original method set cost with stock_valuation_layer, which is a fiscal value
        not the better one for an internal evaluation.
        """
        ...
        if finished_move:
            ...
            if finished_move.product_id.cost_method not in ("fifo", "average"):
                ...
                # todo get actual cost from consumed_moves
