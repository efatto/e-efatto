...
class TestIotInputMrp(TestProductionData):
            ...
            [
                {
                    ...
                    "call_model_id": cls.env.ref(
                        "iot_input_data.model_iot_input_data"
                    ).id,
            ...
            [
                {
                    ...
                    "bom_line_ids": [
                        (
                            0,
                            0,
                            {"product_id": cls.product_weight.id, "product_qty": 2.55},
                        ),
                        (
                            0,
                            0,
                            {"product_id": cls.product_weight1.id, "product_qty": 8.13},
                        ),
                        (
                            0,
                            0,
                            {
                                "product_id": cls.product_weight2.id,
                                "product_qty": 12.01,
                            },
                        ),
                    ],
    ...
    #         }
    #     )
    #     production.with_user(self.mrp_user).button_plan()
    #     production.with_user(self.mrp_user).action_assign()
    #     self.assertTrue(production.workorder_ids)
    #     # production weight more than estimated: 12.787 instead of 11.345
    #     self.input_data(
    #         variable_weight=12.78, variable_duration=453, variable_bag_count=116
    #     )
    ...
    #     )
    #     time.sleep(2)
    #     last_workorder.with_user(self.mrp_user).record_production()
    #     time.sleep(2)
    ...
    #     self.input_data(
    #         variable_weight=10.14, variable_duration=600, variable_bag_count=121
    #     )
    #     for workorder in production.workorder_ids:
    #         workorder.with_user(self.mrp_user).button_start()
    #         time.sleep(2)
    ...
    #     self.assertTrue(production.workorder_ids)
    #     self.input_data(
    #         variable_weight=120.57, variable_duration=7200, variable_bag_count=233
    #     )
    #     for workorder in production.workorder_ids:
    #         workorder.with_user(self.mrp_user).button_start()
    #         time.sleep(2)
