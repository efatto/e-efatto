...
class MrpProduction(models.Model):
    ...
    def _compute_estimated_duration(self):
        for production in self:
            production.estimated_duration = (
                production.routing_id.estimated_duration * production.product_qty
            )
            production.estimated_days_duration = (
                production.routing_id.estimated_days_duration * production.product_qty
            )
